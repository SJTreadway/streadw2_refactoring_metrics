...
public class EventsPanel extends JPanel {
	...
	int rtype;
        ...
        // Fix for Code Smell Task 3.1
        Event event = new Event(rtype, sd, ed, period, hh, mm, text, dlg.workingDaysOnlyCB.isSelected());
        EventsManager.createRepeatableEvent(event);
    }
